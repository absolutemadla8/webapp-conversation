  ...
  */
  ...
  return (
    <div className='bg-gray-100'>
      ...
      />
      <div className="flex flex-row rounded-t-2xl bg-white overflow-hidden">
        {/* sidebar */}
        ...
        <div className="mt-5 w-[20%]">
          ...
          <div className="w-full mr-5 mt-5">
            <ul className="flex flex-wrap gap-2">
              ...
              <li className="bg-blue-100 px-3 py-1 rounded-full">Alcohol</li>
              <li className="bg-blue-100 px-3 py-1 rounded-full">Sugar</li>
              <li className="bg-blue-100 px-3 py-1 rounded-full">Diabetes</li>
              <li className="bg-blue-100 px-3 py-1 rounded-full">Protien</li>
              <li className="bg-blue-100 px-3 py-1 rounded-full">Keto</li>
            </ul>
          </div>
        </div>
      </div>
