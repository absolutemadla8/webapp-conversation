      ...
      <div className="min-h-screen bg-white text-neutral-900">
        <div className="container mx-auto px-6 sm:px-20 pt-24">
          ...
          <div className="flex flex-col md:flex-row gap-10 mb-10">
            {/* <div className="flex flex-col w-full md:w-2/3 h-[700px] object-left mb-6">
              <ConfigSence
              ...
              />
              {hasSetInputs && (
                <div className='absolute inline-block w-[50%] mt-20 overflow-y-auto' ref={chatListDomRef}>
                  <Chat
                    chatList={chatList}
                    onSend={handleSend}
            ...
            <iframe
              src="https://udify.app/chatbot/JgWWxQLYKglevTCX"
              className="w-[100%] h-[100%] min-h-[600px]"
              frameborder="0"
              allow="microphone">
            </iframe>
          ...
          <div className="mb-10">
            ...
            <div className="flex flex-col md:flex-row gap-4 overflow-x-auto">
              <div className="bg-gray-100 border p-4 rounded-xl w-full md:w-1/4">
