  ...
  return (
    <div className='bg-gray-100 mb-20'>
      ...
      <div className="min-h-screen bg-white text-neutral-900">
        <div className="container mx-auto px-6 sm:px-20 pt-24">

          <div className="flex flex-col md:flex-row gap-10 mb-10">
            <div className="flex flex-col w-full md:w-2/3 h-96 object-left mb-6">
              <ConfigSence
          ...
          <div className="mb-20">
            ...
            <div className="flex flex-col md:flex-row gap-4 overflow-x-auto">
              <div className="bg-gray-100 p-4 rounded-xl w-full md:w-1/4">
